        ...
        <Section style={{ width: "100%", padding: "5%", backgroundColor: "#F2F4F7", color: "#4B5563" }}>
          <Section style={{ backgroundColor: "#FFFFFF", padding: "20px", borderRadius: "8px" }}>
            ...
            <Text style={{ fontSize: "16px", color: "black" }}>
              Starting something new can be overwhelming, but we are here to make it easier. <br />
            ...
            <Text style={{ color: "#1F2937", fontSize: "16px", fontWeight: "600" }}>If you need additional help, please reply to this message.</Text>

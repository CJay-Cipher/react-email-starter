      ...
      <Container style={{ width: "100%", maxWidth: "600px", margin: "0 auto" }}>
        ...
        <Section style={{ width: "100%", padding: "2% 3% 0", backgroundColor: "#F2F4F7", color: "#4B5563" }}>
          <Section style={{ backgroundColor: "#FFFFFF", padding: "3%", borderRadius: "8px" }}>
            ...
            >
              Your expenses this week means you have NGN 20,000.00 left of your August Budget.
            </Section>
            <Section
              style={{
                width: "100%",
            ...
            >
              Invoices received this week brings your total invoices for august to 20 at an average amount of NGN 15,000.00
            </Section>
        ...
        <Section style={{ width: "100%", padding: "2% 3% 0", backgroundColor: "#F2F4F7", color: "#4B5563" }}>
          <Section style={{ backgroundColor: "#FFFFFF", padding: "3%", borderRadius: "8px" }}>
            ...
            >
              Your most loyal client was XYZ Corp, with 15 invoices paid.
            </Section>
            <Section
              style={{
                width: "100%",
            ...
            >
              You've received 30% (NGN 300,000.00) of your potential income for Aug. It might be time to reach out to customers to receive payments for 05 overdue
              invoices. Log In Now and Send reminders.
            </Section>
            <Row style={{ marginTop: "20px" }}>
              <Column align="center">
                <Button
        ...
        <Section style={{ width: "100%", padding: "2% 3% 3%", backgroundColor: "#F2F4F7", color: "#4B5563" }}>
          <Section style={{ backgroundColor: "#FFFFFF", padding: "3%", borderRadius: "8px" }}>
            ...
            >
              Transport remains your most frequent expense for the 3rd week in a row, amounting to NGN 15,000.00 of your total expense this past week.
            </Section>
            <Row style={{ marginTop: "20px" }}>
              <Column align="center">
                <Button
